...
// Durations in whole notes; read from corrected LilyPond Fig. 7–8.
let examples: [(String, [(UInt8, Double)], [(UInt8, Double)])] = [
    ("fig07", [(65,1),(64,1),(65,1),(64,1)], [(62,1),(57,1),(62,0.5),(60,0.25),(58,0.25),(57,1)]),
    ("fig08", [(74,1),(67,1),(74,0.25),(72,0.25),(71,0.25),(69,0.25),(67,1),(72,1),(74,1),(72,1),(74,1)], [(62,1),(60,1),(62,1),(60,1),(60,1),(67,1),(60,0.25),(62,0.25),(64,0.25),(65,0.25),(67,1)])
]
for (name, upper, lower) in examples {
    let voices = [Voice(notes: upper, channel: 0, velocity: 80, pan: 56), Voice(notes: lower, channel: 1, velocity: 80, pan: 72)]
    try render(title: name, voices: voices, outputURL: outputDirectory.appendingPathComponent(name + ".wav"))
}
